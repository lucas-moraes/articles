...
**IPs Privados*: São usados dentro da sua casa ou empresa (a rede interna). Eles não valem na internet aberta. Vários roteadores no mundo usam exatamente os mesmos IPs privados (como o famoso `192.168.0.1`).  
