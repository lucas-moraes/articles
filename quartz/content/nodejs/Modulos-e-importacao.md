...
**Quando usar cada um?**.
→ **ES Modules:** Use em **todos os projetos novos.** É o padrão oficial, permite _Tree Shaking_ (remover código não usado no build) e funciona nativamente no navegador e no Node.  
